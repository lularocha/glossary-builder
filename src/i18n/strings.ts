...
export const strings: Record<Language, UIStrings> = {
  ...
  pt: {
    ...
    // Intro paragraph
    introParagraph: 'Crie glossários com Claude AI.<br />Basta inserir um único termo (Palavra Semente) e gerar automaticamente 12 termos relacionados com definições claras. O resultado é otimizado para contextos técnicos, científicos e educacionais em qualquer idioma.',
